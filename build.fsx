...
let project = "ScriptCs.Paket"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "A module allowing you to use Paket with scriptcs (instead of Nuget)"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A module allowing you to use Paket with scriptcs (instead of Nuget)"
// List of author names (for NuGet package)
let authors = [ "filipw" ]
// Tags for your project (for NuGet package)
let tags = "scriptcs F# fsharp paket"

// File system information 
// (<solutionFile>.sln is built during the building process)
let solutionFile = "ScriptCs.Paket.sln"
...
let gitName = "scriptcs-paket"
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/scriptcs-contrib/scriptcs-paket"
...
Target "NuGet" (fun _ ->
    let paketVersion = GetPackageVersion "packages" "Paket.Core"
    ...
    NuGet (fun p -> 
        { p with   
            ...
            Dependencies = [ "Paket.Core", paketVersion
                             "ScriptCs.Hosting", scriptcsVersion ]
            Files = [ (@"bin\Release\ScriptCs.Paket.dll", Some "lib/net40", None)
                      (@"bin\Release\ScriptCs.Paket.xml", Some "lib/net40", None)
                      (@"bin\Release\ScriptCs.Paket.pdb", Some "lib/net40", None) ] })
        (project + ".nuspec")
)
